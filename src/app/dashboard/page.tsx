...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <SearchSection />
      <NoticeMarquee message="📢 Holiday Notice: We will be closed on 14th January 2026 (Makar Sankranti). 🪁✨ On this auspicious occasion, we wish you and your family happiness, prosperity, and success. Happy Makar Sankranti! 🌾☀️" />
